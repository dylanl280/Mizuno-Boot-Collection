...
window.BOOTS = [
...

  {
    ...
    soleplate: "Ultralight nylon, outrigger and reinforced shank",
    collar: "Conventional tongue",
    madeIn: "Japan",
    retailUsd: null,
...

  {
    ...
    collar: "Conventional tongue, BareFoot KNIT NEO opening",
    madeIn: "Japan",
    retailUsd: null,
    lastName: "Engineered Fit Last NEO",
    tech: [
...

  {
    ...
    lastName: "Engineered Fit Last NEO",
    tech: [
      "BareFoot KNIT NEO opening, worn with a conventional tongue",
      "External heel counter, nylon over TPU",
      "Ultralight outsole",
      "Suede insole surface for grip",
      "24-hour lasting process"
...

  {
    ...
    lastName: "Engineered Fit Last NEO",
    tech: [
      "Mizuno Kangaroo Leather forefoot",
...

  {
    ...
    lastName: "Engineered Fit Last",
    tech: [
      "Finest-grade kangaroo leather forefoot",
...

  {
    ...
    model: "Morelia II M8",
    tier: "Made in Japan",
    colorway: "Pearl White — Super White Pearl / Black",
    year: 2020,
    surface: ["FG"],
    weightG: null,
    upper: "Premium kangaroo leather, cross-stitch vamp",
    lining: "High-density micro taffeta",
    soleplate: "Septon, multi-surface",
    collar: "Short tongue",
    madeIn: "Japan",
    ...
    lastName: "Engineered Fit Last",
    tech: [
      "Cross-stitch vamp, a lattice worked across the forefoot",
      "Short tongue",
      "Premium kangaroo leather upper",
      "Gold Morelia script at the heel",
...

  {
    ...
    surface: ["FG"],
    weightG: 195,
    upper: "Synthetic knit with integrated tongue",
    lining: "Knit",
